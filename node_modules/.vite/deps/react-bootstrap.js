import {
  ...
  require_warning,
  useCol
} from "./chunk-3JPAFTGI.js";
import {
  InputGroupContext_default,
  InputGroup_default
} from "./chunk-QQNONG4U.js";
import "./chunk-KD4JVJTT.js";
import {
  CardHeaderContext_default,
  CardImg_default,
  Card_default,
  divWithClassName_default
} from "./chunk-5KB6PUKP.js";
import {
  DEFAULT_BREAKPOINTS,
...
function useDropdownMenu(options = {}) {
  const context4 = (0, import_react36.useContext)(DropdownContext_default);
...
var DropdownToggle2 = React38.forwardRef(({
  ...
  return (0, import_jsx_runtime33.jsx)(Component2, {
    className: (0, import_classnames21.default)(className, prefix, split && `${prefix}-split`, !!isInputGroup && (dropdownContext == null ? void 0 : dropdownContext.show) && "show"),
    ...toggleProps,
    ...props
  });
});
  ...
  return (0, import_jsx_runtime34.jsx)(DropdownContext_default2.Provider, {
    ...
    children: (0, import_jsx_runtime34.jsx)(Dropdown_default, {
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime34.jsx)(Component2, {
        ...props,
        ref,
        className: (0, import_classnames22.default)(className, show && "show", (!drop || drop === "down") && prefix, drop === "up" && "dropup", drop === "end" && "dropend", drop === "start" && "dropstart")
      })
    })
  });
});
...
var Modal = (0, import_react49.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime44.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime44.jsx)("div", Object.assign({}, dialogProps, {
    children: React49.cloneElement(children, {
      role: "document"
    })
  }));
  if (Transition2) {
    dialog = (0, import_jsx_runtime44.jsx)(Transition2, {
      appear: true,
      unmountOnExit: true,
      in: !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition3) {
      backdropElement = (0, import_jsx_runtime44.jsx)(BackdropTransition3, {
        appear: true,
        in: !!show,
  ...
  return (0, import_jsx_runtime44.jsx)(import_jsx_runtime45.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime46.jsxs)(import_jsx_runtime45.Fragment, {
...
var AbstractModalHeader = React52.forwardRef(({
  ...
  const context4 = (0, import_react50.useContext)(ModalContext_default);
  ...
  return (0, import_jsx_runtime49.jsxs)("div", {
    ref,
    ...props,
    children: [children, closeButton && (0, import_jsx_runtime48.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick
    })]
...
var Modal2 = React54.forwardRef(({
  ...
  const renderBackdrop = (0, import_react51.useCallback)((backdropProps) => (0, import_jsx_runtime51.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime51.jsx)("div", {
    ...
    className: (0, import_classnames30.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`),
...
var NavLink = React55.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav2 = React56.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime59.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React62.forwardRef(({
  ...
  const renderBackdrop = (0, import_react57.useCallback)((backdropProps) => (0, import_jsx_runtime59.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime61.jsxs)(import_jsx_runtime60.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime59.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React63.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime62.jsx)(Offcanvas_default, {
    ref,
...
var Overlay = React66.forwardRef((props, outerRef) => {
  ...
  if (Transition2) {
    ...
    child = (0, import_jsx_runtime66.jsx)(Transition2, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime72.jsxs)(import_jsx_runtime71.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react64.cloneElement)(children, triggerProps), (0, import_jsx_runtime70.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React71.forwardRef(({
    children,
    ...props
...
var TabPanel = React81.forwardRef((_ref2, ref) => {
  let {
    as: Component2 = "div"
  ...
  return (0, import_jsx_runtime85.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime85.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime85.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
var ToastFade = React88.forwardRef((props, ref) => (0, import_jsx_runtime94.jsx)(Fade_default, {
  ...props,
  ref,
...
var Toast = React91.forwardRef(({
  ...
  return (0, import_jsx_runtime97.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime97.jsx)(Transition2, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
